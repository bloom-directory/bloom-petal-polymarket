...
use crate::polymarket::order_model::{OrderDraft, OrderReceipt};
use crate::polymarket::types::Side;
use crate::polymarket::{PolymarketError, Result, validate_wallet_name};
...
pub fn render_plan_md(d: &OrderDraft) -> String {
    use crate::polymarket::order::format_micro;
