...
pub fn store_wallets(prefix: &str) -> Vec<String> {
...
pub fn vfs_wallets_or_store(store_prefix: &str) -> Vec<String> {
...
pub fn safe_wallet_names(names: Vec<String>) -> Vec<String> {
    let mut out = Vec::new();
    for name in names {
...
pub fn store_ids(prefix: &str, suffix: &str) -> Vec<String> {
    let Ok(keys) = petal::sdk::store_list(prefix, MAX_LIST_BYTES) else {
        return Vec::new();
    };
    let mut out = Vec::new();
...
pub fn next_id(prefix: &str, suffix: &str) -> String {
