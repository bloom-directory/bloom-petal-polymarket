...
/// Owner-signing operations required by the onboarding flow.
///
/// A direct signer uses the local key. A sealed signer can implement this
/// trait by routing hash signing through its host approval boundary.
